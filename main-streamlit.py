import sys
import os
sys.path.append(os.path.abspath('C:/Users/shrut/Desktop/EnhanceAI-main/MIRNet'))
...
if rad1 == "Home":
    st.image('C:/Users/shrut/Desktop/EnhanceAI-main/images/landing.png', width=1000)
